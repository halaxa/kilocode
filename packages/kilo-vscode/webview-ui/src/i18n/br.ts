export const dict = {
  ...
  "settings.agentBehaviour.editMode.whenToUse": "Quando Usar",
  "settings.agentBehaviour.editMode.whenToUse.help": "Informa ao orquestrador quando delegar tarefas a este agente.",
  "settings.agentBehaviour.editMode.whenToUse.placeholder":
    "ex.: Use este agente quando o usuário solicitar revisão de código ou análise de qualidade",
  "settings.agentBehaviour.editMode.whenToUse.none": "Nenhuma descrição definida para este agente integrado.",
