...
export const dict = {
  ...
  "settings.agentBehaviour.editMode.whenToUse": "何時使用",
  "settings.agentBehaviour.editMode.whenToUse.help": "告知編排器何時將任務委派給此代理。",
  "settings.agentBehaviour.editMode.whenToUse.placeholder": "例如：當使用者請求程式碼審查或品質分析時使用此代理",
  "settings.agentBehaviour.editMode.whenToUse.none": "此內建代理未定義描述。",
