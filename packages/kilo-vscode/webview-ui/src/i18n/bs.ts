export const dict = {
  ...
  "settings.agentBehaviour.editMode.whenToUse": "Kada koristiti",
  "settings.agentBehaviour.editMode.whenToUse.help": "Govori orkestratoru kada da delegira zadatke ovom agentu.",
  "settings.agentBehaviour.editMode.whenToUse.placeholder":
    "npr. Koristi ovog agenta kada korisnik traži pregled koda ili analizu kvaliteta",
  "settings.agentBehaviour.editMode.whenToUse.none": "Nema definiranog opisa za ovog ugrađenog agenta.",
