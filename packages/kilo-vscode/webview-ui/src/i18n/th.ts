export const dict = {
  ...
  "settings.agentBehaviour.editMode.whenToUse": "เมื่อไหร่ควรใช้",
  "settings.agentBehaviour.editMode.whenToUse.help": "บอกตัวประสานงานว่าควรมอบหมายงานให้เอเจนต์นี้เมื่อใด",
  "settings.agentBehaviour.editMode.whenToUse.placeholder":
    "เช่น ใช้เอเจนต์นี้เมื่อผู้ใช้ขอให้ตรวจสอบโค้ดหรือวิเคราะห์คุณภาพ",
  "settings.agentBehaviour.editMode.whenToUse.none": "ไม่มีคำอธิบายที่กำหนดไว้สำหรับเอเจนต์ในตัวนี้",
