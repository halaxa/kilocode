export const dict = {
  ...
  "settings.agentBehaviour.editMode.whenToUse": "متى يُستخدم",
  "settings.agentBehaviour.editMode.whenToUse.help": "يُخبر المنسق متى يجب تفويض المهام لهذا الوكيل.",
  "settings.agentBehaviour.editMode.whenToUse.placeholder":
    "مثال: استخدم هذا الوكيل عندما يطلب المستخدم مراجعة الكود أو تحليل الجودة",
  "settings.agentBehaviour.editMode.whenToUse.none": "لم يتم تحديد وصف لهذا الوكيل المدمج.",
