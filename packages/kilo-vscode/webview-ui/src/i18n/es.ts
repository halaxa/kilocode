export const dict = {
  ...
  "settings.agentBehaviour.editMode.whenToUse": "Cuándo usar",
  "settings.agentBehaviour.editMode.whenToUse.help": "Indica al orquestador cuándo delegar tareas a este agente.",
  "settings.agentBehaviour.editMode.whenToUse.placeholder":
    "ej. Usa este agente cuando el usuario solicite revisión de código o análisis de calidad",
  "settings.agentBehaviour.editMode.whenToUse.none": "No se ha definido una descripción para este agente integrado.",
