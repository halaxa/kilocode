export const dict = {
  ...
  "settings.agentBehaviour.editMode.whenToUse": "Quand utiliser",
  "settings.agentBehaviour.editMode.whenToUse.help": "Indique à l'orchestrateur quand déléguer des tâches à cet agent.",
  "settings.agentBehaviour.editMode.whenToUse.placeholder":
    "ex. Utiliser cet agent lorsque l'utilisateur demande une revue de code ou une analyse qualité",
  "settings.agentBehaviour.editMode.whenToUse.none": "Aucune description définie pour cet agent intégré.",
