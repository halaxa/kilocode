...
export const dict = {
  ...
  "settings.agentBehaviour.editMode.whenToUse": "何时使用",
  "settings.agentBehaviour.editMode.whenToUse.help": "告知编排器何时将任务委派给此代理。",
  "settings.agentBehaviour.editMode.whenToUse.placeholder": "例如：当用户请求代码审查或质量分析时使用此代理",
  "settings.agentBehaviour.editMode.whenToUse.none": "此内置代理未定义描述。",
