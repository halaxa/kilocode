export const dict = {
  ...
  "settings.agentBehaviour.editMode.whenToUse": "Kiedy używać",
  "settings.agentBehaviour.editMode.whenToUse.help": "Informuje orkiestratora, kiedy delegować zadania do tego agenta.",
  "settings.agentBehaviour.editMode.whenToUse.placeholder":
    "np. Użyj tego agenta, gdy użytkownik prosi o przegląd kodu lub analizę jakości",
  "settings.agentBehaviour.editMode.whenToUse.none": "Nie zdefiniowano opisu dla tego wbudowanego agenta.",
