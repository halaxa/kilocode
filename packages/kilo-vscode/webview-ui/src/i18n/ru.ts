export const dict = {
  ...
  "settings.agentBehaviour.editMode.whenToUse": "Когда использовать",
  "settings.agentBehaviour.editMode.whenToUse.help": "Сообщает оркестратору, когда делегировать задачи этому агенту.",
  "settings.agentBehaviour.editMode.whenToUse.placeholder":
    "напр. Используйте этого агента, когда пользователь запрашивает ревью кода или анализ качества",
  "settings.agentBehaviour.editMode.whenToUse.none": "Описание для этого встроенного агента не задано.",
